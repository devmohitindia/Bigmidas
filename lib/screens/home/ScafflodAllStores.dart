...
class ScafflodAllStores extends StatefulWidget {
  @override
  _ScafflodAllStoresState createState() => _ScafflodAllStoresState();
}

class _ScafflodAllStoresState extends State<ScafflodAllStores> {
