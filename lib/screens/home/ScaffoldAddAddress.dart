...
class ScaffoldAddAddress extends StatefulWidget {
  @override
  _ScaffoldAddAddressState createState() => _ScaffoldAddAddressState();
}

class _ScaffoldAddAddressState extends State<ScaffoldAddAddress> {
