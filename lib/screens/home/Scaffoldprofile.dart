...
class Scaffoldprofile extends StatefulWidget {
  @override
  _ScaffoldprofileState createState() => _ScaffoldprofileState();
}

class _ScaffoldprofileState extends State<Scaffoldprofile> {
